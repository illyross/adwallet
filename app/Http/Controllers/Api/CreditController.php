    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if ($existingTransaction) {
            ...
            return response()->json([
                ...
                'credited_at' => $existingTransaction->completed_at?->toIso8601String() 
        ...
        try {
            $result = DB::transaction(function () use (
                ...
                $transaction = $account->transactions()->create([
                    'reference' => $transactionId, // Use transaction_id as reference for credits
                    'transaction_id' => $transactionId,
                    'credits' => $credits,
                    'amount' => $amount,
                    'currency' => $currency,
            ...
            return response()->json([
                ...
                'credited_at' => $result['transaction']->completed_at->toIso8601String(),
            ], 200);
